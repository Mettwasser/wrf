...
impl From<SetUsernameArgs> for super::Reducer {
    fn from(args: SetUsernameArgs) -> Self {
        Self::SetUsername { name: args.name }
    }
}
...
pub trait set_username {
    ...
    fn set_username(&self, name: String) -> __sdk::Result<()> {
        self.set_username_then(name, |_, _| {})
    }
...
impl set_username for super::RemoteReducers {
    fn set_username_then(
        ...
        self.imp
            .invoke_reducer_with_callback(SetUsernameArgs { name }, callback)
    }
}
