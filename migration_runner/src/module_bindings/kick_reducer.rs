...
pub trait kick {
    ...
    /// /// Use [`kick:kick_then`] to run a callback after the reducer completes.
    fn kick(&self, user: u32) -> __sdk::Result<()> {
        self.kick_then(user, |_, _| {})
    }
...
impl kick for super::RemoteReducers {
    fn kick_then(
        ...
        self.imp
            .invoke_reducer_with_callback(KickArgs { user }, callback)
    }
}
